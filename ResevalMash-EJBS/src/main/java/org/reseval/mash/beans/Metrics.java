...
public class Metrics implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (this.metricsStandard != other.metricsStandard && (this.metricsStandard == null || !this.metricsStandard.equals(other.metricsStandard))) {
            return false;
        }
        if (this.metricsWithoutSelfCitations != other.metricsWithoutSelfCitations && (this.metricsWithoutSelfCitations == null || !this.metricsWithoutSelfCitations.equals(other.metricsWithoutSelfCitations))) {
            return false;
        }
        if (this.reputationBased != other.reputationBased && (this.reputationBased == null || !this.reputationBased.equals(other.reputationBased))) {
            return false;
        }
        if (this.keynoteCount != other.keynoteCount && (this.keynoteCount == null || !this.keynoteCount.equals(other.keynoteCount))) {
            return false;
        }
        return true;
    }
